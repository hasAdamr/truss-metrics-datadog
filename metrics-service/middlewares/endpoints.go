...
func WrapEndpoints(in svc.Endpoints) svc.Endpoints {
	...
	// These middlewares get passed the endpoint name as their first argument when applied.
...
// requestLatency is a LebeledMiddleware, reporting the request time of and
...
// name will be populated with the endpoints name, and such this middleware will
// report errors to the metric provider with the endpoints name. Feel free to
